...
#2. Why Devops?
    ❌ Before DevOps
        ...
        🧪 QA → tested manually (👉 No one worked together as one team)
    😵 Problems
...
#3. What is SDLC?
     SDLC (Software Development Life Cycle) is the step-by-step process used to build, test, deploy, and maintain software.(SDLC is the process that teams follow to take an idea and turn it into a working software application.) In DevOps, SDLC is automated and continuous to deliver software faster and more reliably.

     #. Stages of SDLC :- Plan → Develop → Build → Test → Release → Deploy
       
     Eg: escbash.com (Bash Scripting Website)
         # Scenario
            # Users request new features: Dark mode - Script download button
